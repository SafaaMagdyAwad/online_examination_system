...
@else
        ...
        {{-- student answer --}}
        <div>
            <input type="text"  name="question" value="{{$discriptiveQuestion['question']}}" hidden>
        </div>
        <div>
            <input type="textarea"  name="ans" value="{{$discriptiveQuestion['ans']}}" hidden>
        </div>
        <div>
            <label>{{$discriptiveQuestion['mark']}} marks</label>
            <input type="textarea"  name="full_mark" value="{{$discriptiveQuestion['mark']}}" hidden>
        </div>
        <div>
            <input type="textarea"  name="mark" value="0" hidden>{{-- student degree changeble --}}
        </div>
        {{-- select boxes --}}
        <div>
        ...
        <div>
            <input name="student_id" value="{{$logedinuser['id']}}" hidden>
        </div>
