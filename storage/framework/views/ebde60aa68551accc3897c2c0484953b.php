      ...
      <div class="container">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav mx-auto">
                  ...
                  <li class="nav-item">
                    <a href="<?php echo e(route('game')); ?>" class="nav-link" >play games</a>
      
                  </li>
                  <li class="nav-item">
                    <a href="<?php echo e(route('bmiform')); ?>" class="nav-link" >Be healthy</a>
      ...
      <div class="container">
          <div class="row">
              ...
              <div class="col-lg-3 col-10 me-auto mb-4">
                  <h4 class="text-white mb-3"><a href="<?php echo e(route('start')); ?>">online </a> exam</h4>
                  <br>
              </div>
