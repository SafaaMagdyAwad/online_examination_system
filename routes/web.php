...
Route::get('update_form/{id}', [UserController::class,'update_form'])->name('user.update_form');
...
Route::group(['middleware'=> 'user'], function () {
    ...
    Route::post('store_stu_ans_discriptive/{exam_id}',[StudentAnswerController::class,'store_stu_ans_discriptive'])->name('store_stu_ans_discriptive');
