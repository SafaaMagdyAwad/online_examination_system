            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="row">
                        ...
                        <a href="<?php echo e(route('question.add_form',$exam['id'])); ?>" style="display: inline" class="btn btn-success input mt-1 form-control loginPass">add questions</a>
                    </div>
                </div>
            </div>
        </div>
   ...
   <tbody>
    ...
    <tr>
            ...
            <td>
                ...
                <a href="<?php echo e(route('question.update_form',$question['id'])); ?>" class=" btn btn-warning input mt-1 form-control loginPass">update  question</a>
                
                <form method="POST" style="display: inline" action="<?php echo e(route('exam.delete',)); ?>"  >
                    <?php echo csrf_field(); ?>
