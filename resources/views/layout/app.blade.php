    ...
    <nav class="navbar navbar-expand-sm pt-1 rounded bg-success text-center text-light ">
      <div class="container">
        ...
        <div class="webname" >
          ...
          <span class="me-3 fs-5" >@yield('user')</span>
        </div>
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavId">
          ...
          <ul class="navbar-nav me-auto mt-2 mt-lg-0 ">
            ...
            <li>  
              <a  class="btn btn-success input m-1 form-control loginPass">{{date("H:i:s");}}</a>  
            </li>
            <li>  
              <a  class="btn btn-success input m-1 form-control loginPass">{{date("Y:M:d:D");}}</a>
            </li>
            <li>  
             @yield('link1')
            </li>
            ...
            <li>
              <a href="{{route('game')}}" class="btn btn-success" >play games</a>
